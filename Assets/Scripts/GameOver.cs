...
public class GameOver : MonoBehaviour {
    ...
    public void GameOverStopGame() {
        ...
        //gameOverText.text = "Glueckwunsch " + MyPlayerName.namePlayerOne ? MyPlayerName.namePlayerOne : "ErrByGettingPlayName" + "\nDu hast " + MyScore.getScorefield() ? MyScore.getScorefield() : "ErrByGettingScoreField" + " Punkte erzielt";
